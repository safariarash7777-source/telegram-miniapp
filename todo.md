...
## فاز ۳ - شبکه‌های اجتماعی و لوگوهای جدید
- [x] آپلود لوگوهای جدید برند (navy/white با تیر و کمان) به CDN
- [x] جایگزینی لوگوهای قدیمی در Dashboard، TelegramLogin، ProfileSetup
- [x] ساخت صفحه "درباره من" (About) با پست‌های اخیر کانال تلگرام @arashsafariiiiiiii
- [x] اضافه کردن لینک‌های شبکه‌های اجتماعی: تلگرام، اینستاگرام، X، یوتیوب (@roadmap_investing)
- [x] اضافه کردن تب "درباره من" به BottomNav
- [x] ردیرکت به صفحه "درباره من" بعد از ثبت موفق مشاوره
- [ ] push به GitHub
